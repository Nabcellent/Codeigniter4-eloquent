...
class PublishCommand extends BaseCommand {
     ...
     * @var string
     */
    protected $name = 'eloquent:publish';
     ...
     * @var string
     */
    protected $description = 'Publish config eloquent to folder App\Config';
     ...
     * @var string
     */
    protected $usage = 'eloquent:publish';
    ...
    protected function publishConfig() {
        $path = "{$this->sourcePath}/Config/Eloquent.php";

        $content = file_get_contents($path);
        $content = str_replace('namespace Fluent\Config', 'namespace App\Config', $content);

        $this->writeFile('Config/Eloquent.php', $content);
    }
